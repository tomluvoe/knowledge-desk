...
README_BLURBS: dict[str, str] = {
    ...
    "memory": "User conclusions, decisions, open questions, and multi-page workspaces (distinct from source evidence).",
    "memory/conclusions": "User conclusions.",
    "memory/decisions": "User decisions.",
    "memory/open-questions": "Open questions.",
    "memory/workspaces": "User-owned multi-page workbenches (thesis, framework, …). Not auto-written by wiki evolve or maintainer.",
