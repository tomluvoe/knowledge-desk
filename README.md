...
Generated indexes and future MCP views sit downstream and must always be rebuildable. See [the architecture](docs/architecture.md), [artifact model](docs/artifact-model.md), [implementation notes](docs/implementation-notes.md), and the authoritative [agent contract](AGENTS.md).
...
evidence-vault ingest path/to/source.pdf
evidence-vault ingest inbox/
...
.venv/bin/evidence-vault validate
```
